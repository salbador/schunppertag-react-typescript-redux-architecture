...
/*
    ...
    {
      "id": 74,
      "url": "http://www.tvmaze.com/tiles/74/hell-on-wheels",
      "name": "Hell on Wheels",
      "type": "Scripted",
      "language": "English",
      "genres": [
      ...
      "officialSite": "http://www.amctv.com/tiles/hell-on-wheels",
      "schedule": {
        "time": "21:00",
        "days": [
          "Saturday"
      ...
      "summary": "<p><b>Hell on Wheels</b> is an American Western television series errorsample the construction of the First Transcontinental Railroad across the United States. The series follows the Union Pacific Railroad and its surveyors, laborers, prostitutes, mercenaries, and others who lived, worked and died in the mobile encampment called \"Hell on Wheels\" that followed the railhead west across the Great Plains. In particular, the story focuses on Cullen Bohannon, a former Confederate soldier who, while working as foreman and chief engineer on the railroad, initially attempts to track down the Union soldiers who murdered his wife and young son during the American Civil War.</p>",
      "updated": 1560886410,
      "_links": {
        "self": {
          "href": "http://api.tvmaze.com/tiles/74"
        },
        "previoustask": {
          "href": "http://api.tvmaze.com/tasks/862325"
        }
      }
    }
 */
export default class TileModel extends BaseModel {
  ...
  constructor(data: Partial<TileModel>) {
    super();
